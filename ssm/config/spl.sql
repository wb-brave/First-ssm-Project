...
insert into supplier (sup_id,sup_name,sup_linkman,sup_phone,sup_address,sup_remark,sup_pay,sup_type) values (6,'Nokia供应商','小王','12388888777','广东深圳大本营霜叶大本营厅需要要奇才劳而无功村','一级供应商',0,2);
