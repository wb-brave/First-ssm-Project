...
public class BaseServiceImpl<T> implements BaseService<T> {
	...
	private void initBaseMapper() throws Exception{
		//完成以下逻辑，需要对研发本身进行命名与使用规�?
				...
				System.out.println("=======field对应的对�?"+field.get(this));
				Field baseField = this.getClass().getSuperclass().getDeclaredField("baseMapper");
				
				System.out.println("=======baseField:"+baseField);
				System.out.println("=======baseField对应的对�?"+baseField.get(this));	
				//field.get(this)获取当前this的field字段的�?。例如：Supplier对象中，baseMapper�?��向的对象为其子类型SupplierMapper对象，子类型对象已被spring实例化于容器�?	
				baseField.set(this, field.get(this));		
				System.out.println("========baseField对应的对�?"+baseMapper);
